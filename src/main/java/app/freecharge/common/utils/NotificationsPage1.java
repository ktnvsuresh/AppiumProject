...
public class NotificationsPage1  extends DriverInitialization{		
	...
	//MessagesPage messagesPage = nativeNotificationPage.tapItemTitle(notificationItemNum); //messagesPage = our client messages screen
	}
