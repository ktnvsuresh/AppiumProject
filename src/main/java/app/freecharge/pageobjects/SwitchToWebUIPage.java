...
public class SwitchToWebUIPage extends DriverInitialization{		
	...
	public void switchToWebUI() throws InterruptedException{
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath("//android.view.View[contains(@package,'com.android.browser') and contains(@content-desc,'Terms & Conditions')]")).click();
		result = null;
		result = driver.findElement(By.xpath("//android.widget.EditText[contains(@package,'com.android.browser') and @resource-id='com.android.browser:id/url']")).getText();
		Thread.sleep(6000);
		logger.info(result);
